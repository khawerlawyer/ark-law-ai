    ...
    <>
      ...
      <div style={{
        ...
        <div className="logo-section" style={{
          ...
          {/* Logo */}
          <div style={{ position: "relative", marginBottom: "8px", padding: "6px" }}>
            <div style={{
              position: "absolute", inset: "0",
              borderRadius: "50%",
              background: `radial-gradient(circle, ${GOLD}30 0%, transparent 70%)`,
            }} />
            <img src="/ark-logo-us.png" alt="ARK Law AI"
              className="logo-img" style={{ width: "100px", height: "100px", position: "relative", filter: `drop-shadow(0 0 16px ${GOLD}60)` }} />
          </div>
